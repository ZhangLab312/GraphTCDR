...
BATCH_SIZE = 402
LR = 5*1e-5
hiddenDim = [2048*3, 1024]
inDim = 22582  # 拷贝数 22582
outDim = 256
...
def load_data():
    all_data = torch.load('../data/cell_line/CNVFeature402.pt')
...
def train(train_data, test_data, data_all):
    ...
    for epoch in range(EPOCH):
        ...
        if test_loss < best_loss:
            ...
            torch.save(res.data, '../data/cell_line/{}dim_CNV_AE.pt'.format(outDim))
