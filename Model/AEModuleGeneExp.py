...
BATCH_SIZE = 402
LR = 1e-5
hiddenDim = [12000, 3000]
inDim = 20404  # 基因表达特征维度 20404
outDim = 2048
...
def load_data():
    all_data = torch.load('../data/cell_line/GeneExpressionFeature402.pt')
...
def train(train_data, test_data, data_all):
    ...
    for epoch in range(EPOCH):
        ...
        if test_loss < best_loss:
            ...
            torch.save(res.data, '../data/cell_line/{}dim_geneExpression_AE.pt'.format(outDim))
